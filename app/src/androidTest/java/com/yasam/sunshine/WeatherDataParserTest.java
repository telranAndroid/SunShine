...
public class WeatherDataParserTest extends TestCase {
    ...
    /**
     * Tests the getMaxTemperatureForDay(...) result for the day #2 in Mountain View, USA.
     * @throws JSONException
     */
    public void testMountainViewThirdDay() throws JSONException {
        double actualVal = 14.1;
        int dayNum = 2;
        assertEquals(actualVal, MainActivity.WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_MTV_JUN_4, dayNum));
    }

    /**
     * Tests the getMaxTemperatureForDay(...) result for the day #6 in Fremont, USA.
     * @throws JSONException
     */
    public void testFremontLastDay() throws JSONException {
        double actualVal = 16.75;
        int dayNum = 6;
        assertEquals(actualVal, MainActivity.WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_FREMONT_JUN_4, dayNum));
    }
}